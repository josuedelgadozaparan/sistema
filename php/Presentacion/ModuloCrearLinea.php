    ...
    <script type="text/javascript">
         ...
         $(document).ready(function(){
            $("#btnlinea").click(function(){
              //nombrelinea
             var txtnomlinea =document.getElementById('nombrelinea').value;
             if(txtnomlinea.length==0){
              alert("EL CAMPO DE NOMBRE DE LINEA DEBE ESTAR LLENO");
             }
          ...
          <div class="row">
              <div class="col-xs-12 col-ms-12 col-md-12 col-lg-12   ">
                 ...
                 <div class="panel-body">
                      <form class="form-horizontal" action="http://localhost:8080/tarea/php/Presentacion/ModuloLinea.php" role="form" method="POST">
                      ...
                      <button id="btnrealizarlinea" class="btn btn-success btn-sm" style="display:none;" name="procesar" onclick="Procesolinea1()">insertar </button>
