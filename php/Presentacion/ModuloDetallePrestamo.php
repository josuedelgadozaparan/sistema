		...
		if(x=="EDITAR")
		{
           $('#id_modal_valor_configurar').attr('disabled', false); 
            $("#id_modal_valor_configurar").val(global_abono);  
             //$("#id_modalBtnConfigurar").val("HOLAAAA");    
...
var global_abono=0;
	$(document).ready(function(){
		$(".boton2").click(function(){
           ...
           // for(var a=0;a<=2;a++){id_modal_idprestamo_eliminar  id_valor_original_abono
            //alert( valor[a]);
            //}
           // alert("ggg");
           $("#id_modal_idabono_eliminar").val(valor[0]);
           $("#id_modal_idprestamo_eliminar").val(valor[1]);
         		global_abono=  valor[2];
           $("#id_modal_valor_configurar").val(valor[2]);
           $("#id_modal_fecha_eliminar").val(valor[4]);
           $("#id_valor_original_abono").val(valor[2]);
	...
	$descripcion=$decode->DescripcionPrestamo;
                                          						...
                                          						<div class="panel panel-success">
                                          							...
                                          							<div class="table-responsive">
                                          								<table  id="tableabono" class="table" >
                                          									<tr><th style="display:none;">ID</th ><th style="display:none;">IdPrestamo</th><th>Valor__Abono</th><th>PendientePagar</th><th>FechaAabono</th><th  id="campo_eliminar">Configurar</th></tr>
                                          									<?php
                                          				...
                                          				<div class="modal-dialog">
                                          					<div class="modal-content">
                                          						<div class="modal-header">
                                          							...
                                          							<h4 class="modal-title custom_align" id="Heading">CONFIGURACION DEL ABONO</h4>
                                          						</div>
                                          						<div class="modal-body">
                                          							<form class="form-horizontal" role="form" method="POST">
                                          							...
                                          							<input id="id_modal_idabono_eliminar"  style="display:none";  type="text"  class="form-control" maxlength="10"  name="modal_idabono_eliminar" readonly="readonly"/>
                                          							<label for="text" class="col-sm-12" control-label>Abono</label>
                                          							<input id="id_modal_valor_configurar" type="text" class="form-control" maxlength="10" name="modal_valor_configurar" onkeypress="return valida(event)" />
                                          							...
                                          							<input id="id_valor_original_abono" style="display:none";  type="text"   name="valor_original_abono"  class="form-control" maxlength="10" readonly="readonly"/>
                                          						</div>
                                          						<div class="modal-footer ">
     ...
     //  mando el insert de abono
                                          					...
                                          					if ( isset( $_POST['modalBtnConfigurar']  ) ) {
                                          						...
                                          						if(!strcmp($_POST['opcion_configuracion'], "ELIMINAR"))
                                          						{
                                          							$abono_eliminar=new Abono();
                                          						$abono_eliminar->ValidarEliminarAbono($_POST['modal_idabono_eliminar'],$_POST['modal_idprestamo_eliminar'],$_POST['modal_valor_configurar']);
                                          						...
                                          						{
                                          							$abono_editar=new Abono();
                                          						$abono_editar->ValidarEditarAbono($_POST['modal_idabono_eliminar'],$_POST['modal_idprestamo_eliminar'],$_POST['valor_original_abono'],$_POST['modal_valor_configurar']);
