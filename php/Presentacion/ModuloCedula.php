    ...
    <head>
        ...
        <script type="text/javascript">
         $(document).ready(function(){
            $('#frmcedulasi').click(function(){//esquemausuario

            $('#paracrearcliente').fadeIn() 

             $('#esquemausuario').fadeOut() 
            })    

            $('#frmcedulano').click(function(){
              //var pagina="http://localhost:8080/tarea/php/Presentacion/ModuloCliente.php";
    ...
    <div class="row">
         <div class="col-xs-12 col-ms-12 col-md-12 col-lg-12  ">
              <div class="form-group">
                      ...
                      <img src="../../img/img_documento.png" class="img-responsive">
                          ...
                          <label for="password" class="col-sm-2 control-label">DIGITE LA CEDULA</label>
                              <div class="col-sm-10">
                                   <input type="text" class="form-control" id="buscarcedula" name="cedula" onkeypress="return valida(event)" onkeydown="search(this)"> <br>
                                    <br><br><br>
                                    <button  id="mostrar" class="btn btn-primary btn-md" name="buscar">BUSCAR</button>
                              </div>
                        </form>
                    </div>
                         ...
                         <table class="table table-striped"><br><br> 
                             ...
                             <?php
                              require_once '../Negocio/Cliente.php';
                               ...
                               $dato = new Cliente();
                               $ced_=$_POST['cedula'];
                               $vacio=    $dato->ValidarConsultarClienteCedula($_POST['cedula']);
                               if($vacio==false)
                               {?>
                                  ...
                                  <tr>
                                      <th>La cedula con numero <?php echo $ced_;  ?>  no se encuentra registrada en la base de datos.
                                      ¿Desea agregar la cedula como nuevo cliente?
                                      <br>
                                      <button   id="frmcedulasi" class="btn btn-primary btn-md" name="cedsi">SI</button>
                                      
                                      <button type="submit" id="frmcedulano" class="btn btn-primary btn-md" name="cedno">NO</button>
...
<?php 
     ...
     header ("Location:ModuloCientes.php");
     
       }
    //cedno  
       if ( isset( $_POST['cedno']  ) ) { 

header ("Location:ModuloCedula.php");
}
?>
