...
require_once dirname(__FILE__) . '/../Datos/ProcesoInventario.php';
...
public function ValidarActualizarProducto($nom,$val,$can,$canmin,$marca,$iddetalle,$cod,$id,$nomlinea) {
$dato=new ProcesoInventario();

        $dato->ActualizarProducto($nom,$val,$can,$canmin,$marca,$iddetalle,$cod,$id,$nomlinea);
}
